...
exports.recognizePlant = (0, https_1.onCall)({ secrets: ['ANTHROPIC_API_KEY'] }, async (request) => {
    if (!request.auth) {
    ...
    if (content.type !== 'text') {
        throw new https_1.HttpsError('internal', 'Unexpected response type from AI.');
    }
    try {
        ...
        throw new https_1.HttpsError('internal', 'Failed to parse plant identification data.');
    }
});
